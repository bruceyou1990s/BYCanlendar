...
- (NSDate *)yesterdayOlny:(NSDate *)date
{
    NSDateComponents *bruceValue=[self.calendar components:NSCalendarUnitMonth fromDate:date];
    
    return [self.calendar dateFromComponents:bruceValue];
}
